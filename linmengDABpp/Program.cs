...
conn.ConnectionString = "Server = LAPTOP-0M38RHG6\\SQLEXPRESS01; Database = Users; User Id = lin; Password = Svmsung3;";
conn.Open();

// Create the command 
SqlCommand command = new SqlCommand("SELECT * FROM linmengTable", conn);
...
SqlCommand insertCommand = new SqlCommand("INSERT INTO linmengTable (UserId,UserName,  UserEmail) VALUES (@0, @1, @2)", conn);
...
try
{
    ...
    SqlCommand errorCommand = new SqlCommand("SELECT * FROM linmengTable", conn);
